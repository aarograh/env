...
!--- calculate rank from idims array
      ...
      write (2,'(2a,i3)') ' writing dataspace name: ', dsetname
      write (2,*) '  creating dataspace with rank ', irank
      if (irank>0) then
        write (2,*) '  creating dataspace with dims ', idims(1:irank)
      endif
...
! Create the dataspace (information about array)
      ...
      write (2,*) '  created dataspace id        ', dspace_id
