...
for st in xrange(1,nstate+1):
    ...
    data_plot=h5["/STATE_"+"{0:04d}".format(st)+'/NODAL_XS/'+dataset].value
        ...
        for ax in xrange(nxy):
            ...
            if(asy>=0):
                ...
                if(ay>0):
                  ...
                  triag.append([ind*5+2,ind*5+3,ind*5+4])
                  triag.append([ind*5+1,ind*5+2,ind*5+4])
                  pltval[ind*4  ]=plotval(asy,axial,1,grp,0)
                  pltval[ind*4+1]=plotval(asy,axial,1,grp,1)
                  pltval[ind*4+2]=plotval(asy,axial,1,grp,2)
                  pltval[ind*4+3]=plotval(asy,axial,1,grp,3)
                  ind+=1
                #node 3
                if(ax>0):
                  ...
                  triag.append([ind*5+2,ind*5+3,ind*5+4])
                  triag.append([ind*5+1,ind*5+2,ind*5+4])
                  pltval[ind*4  ]=plotval(asy,axial,2,grp,0)
                  pltval[ind*4+1]=plotval(asy,axial,2,grp,1)
                  pltval[ind*4+2]=plotval(asy,axial,2,grp,2)
                  pltval[ind*4+3]=plotval(asy,axial,2,grp,3)
                  ind+=1
                #node 4
                ...
                triag.append([ind*5+2,ind*5+3,ind*5+4])
                triag.append([ind*5+1,ind*5+2,ind*5+4])
                pltval[ind*4  ]=plotval(asy,axial,3,grp,0)
                pltval[ind*4+1]=plotval(asy,axial,3,grp,1)
                pltval[ind*4+2]=plotval(asy,axial,3,grp,2)
                pltval[ind*4+3]=plotval(asy,axial,3,grp,3)
                ind+=1
